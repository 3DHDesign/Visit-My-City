  ...
  return (
    <div>
      ...
      <div className="mt-10 grid gap-4">
        {/* Phone Numbers */}
        <div className="group flex items-start gap-4 rounded-[28px] border border-slate-100 bg-white p-5 shadow-[0_18px_55px_rgba(15,23,42,0.06)] transition-all hover:-translate-y-1 hover:shadow-[0_24px_70px_rgba(15,23,42,0.09)]">
          ...
          <div>
            ...
            <div className="mt-1 flex flex-col gap-1">
              <a
                ...
                className="text-[18px] font-bold !text-[#0B1F33] transition-colors hover:!text-[#2D6A4F]"
              >
                +94 11 460 0900
              </a>
