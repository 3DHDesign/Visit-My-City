...
const ContactHero = () => {
  return (
    <section className="  mb-10 relative min-h-[680px] overflow-hidden bg-[#071827] pt-[160px] pb-2 lg:pt-[170px] lg:pb-28">
      ...
      {/* Overlay */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#071827]/85 via-[#071827]/45 to-[#071827]/10" />
      <div className="absolute inset-0 bg-gradient-to-t from-[#071827]/25 via-transparent to-transparent" />
