...
const RealMomentsGallery = () => {
  return (
    <section className="relative overflow-hidden bg-[#FCFCFA] py-10 lg:py-12">
      <div className="pointer-events-none absolute -left-32 top-20 h-[360px] w-[360px] rounded-full bg-[#2D6A4F]/10 blur-3xl" />

      <div className="pointer-events-none absolute -right-32 bottom-20 h-[360px] w-[360px] rounded-full bg-[#E9A93B]/12 blur-3xl" />
      ...
      <div className="container-wide relative z-10">
        <div className="mx-auto max-w-[1180px]">
          ...
          <div className="mt-9 flex justify-center">
            <Link
              to="/gallery"
              className="inline-flex items-center justify-center gap-3 rounded-full bg-[#0B1F33] px-8 py-4 text-[14px] font-bold !text-white shadow-[0_18px_45px_rgba(11,31,51,0.18)] transition-all duration-300 hover:-translate-y-1 hover:bg-[#2D6A4F] hover:shadow-[0_24px_60px_rgba(11,31,51,0.24)]"
            >
              View Full Gallery
