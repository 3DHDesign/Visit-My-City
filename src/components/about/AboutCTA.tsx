          ...
          <div className="relative z-10 mx-auto max-w-4xl">
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row sm:flex-wrap">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 rounded-full border border-[#0B1F33]/15 bg-white px-7 py-4 text-[14px] font-bold !text-[#0B1F33] shadow-[0_10px_30px_rgba(11,31,51,0.07)] transition-all duration-300 hover:-translate-y-0.5 hover:border-[#2D6A4F]/35 hover:!text-[#2D6A4F]"
              >
                <FiPhone size={16} />
                +94 11 460 0900
              </a>
