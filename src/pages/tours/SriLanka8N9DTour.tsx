...
const IMAGES = {
  ...
  heroMobile:
    "/images/tours/8days/eight-night-nine-day-tour-hero-mobile.jpg",
...
const SriLanka8N9DTour = () => {
    ...
    <main className="bg-[#FCFCFA]">
      ...
      <section className="relative overflow-hidden bg-[#0B1F33] pb-24 pt-36">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#071A2C]/75 via-[#071A2C]/35 to-transparent md:from-[#071A2C]/70 md:via-[#071A2C]/30" />
        </div>
  ...
  <div className="container-wide">
    <div className="mx-auto max-w-3xl text-center">
      ...
      <p className="mt-5 text-[16px] leading-8 !text-slate-600">
        A thoughtfully planned journey through Sri Lanka’s cultural, natural,
        wildlife, hill-country, and coastal regions.
      </p>
    </div>
        ...
        {itinerary.map((item, index) => (
          ...
          >
            ...
            >
              ...
              {/* Content */}
              <div
                className={`relative flex min-h-[260px] flex-col justify-center overflow-hidden bg-gradient-to-br from-white to-[#FCFAF6] p-6 md:p-8 lg:p-10 ${
