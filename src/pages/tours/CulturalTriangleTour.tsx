...
const IMAGES = {
  ...
  heroMobile:
    "/images/tours/cultural-traingle/cultural-triangle-tour-hero-mobile.jpg",
      ...
      <section className="bg-white py-8">
        <div className="container-wide">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-5 text-[16px] leading-8 !text-slate-600">
              These are suggested stops. The final route can be customized according
              to the guest’s arrival city, number of days, and preferred travel style.
            </p>
          </div>
